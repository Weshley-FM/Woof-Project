...
export default function PricingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-natural-100 text-natural-10 font-sans">
      ...
      <main className="relative z-0 pb-24 pt-16 lg:pb-32 lg:pt-20">
        {/* Glow effect */}
        <div className="absolute -left-1/4 -top-1/4 h-[900px] w-[900px] rounded-full bg-[#bfff00]/40 blur-[150px] opacity-100 pointer-events-none" />
        ...
        >
          ...
          {/* Header */}
          <motion.div variants={item} className="flex flex-col items-center text-center gap-6 mt-10">
          ...
          {/* Cards */}
          <motion.div variants={item} className="grid grid-cols-1 gap-8 mt-24 lg:grid-cols-2 lg:gap-10">
            {/* Basic Plan Card */}
                    ...
                    <ul className="mt-6 space-y-5">
                      {[
                        ...
                        <li key={item} className="flex items-center gap-4">
                          <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#2DD4BF] to-[#bfff00] text-black">
              ...
              <div className="relative flex h-full flex-col justify-between rounded-[calc(1.75rem-1px)] bg-[#0a0a0a] p-8 sm:p-10">
                <div>
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-start gap-1">
                      <span className="mt-2 font-mono text-[20px] font-medium text-natural-70">$</span>
                      <span className="font-mono text-[64px] leading-[1] font-medium text-transparent bg-clip-text bg-gradient-to-r from-[#2DD4BF] to-[#bfff00]">699</span>
                      <span className="self-end pb-2 font-mono text-[15px] text-natural-70">/mo</span>
                    </div>
                  </div>
          ...
          <motion.div variants={item} className="mt-32 overflow-x-auto pb-10">
              ...
              <thead>
                <tr>
                  ...
                  <th className="w-1/3 border-b border-l border-white/10 pb-8 px-8 align-top font-normal">
                    ...
                    <button className="mt-6 w-full rounded-xl bg-[#bfff00] py-3.5 text-[15px] font-medium text-black transition-transform duration-200 hover:scale-[1.02]">
                      Get This Plan
                    </button>
                  </th>
                    ...
                    <td className="border-b border-l border-white/10 py-6 px-8 text-center">
                      {typeof row.basic === 'string' ? (
                        ...
                        <div className="flex justify-center">
                          <span className="flex h-[22px] w-[22px] shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#2DD4BF] to-[#bfff00] text-black">
                            <svg className="h-3 w-3" viewBox="0 0 14 10" fill="none">
                              <path d="M1 5L4.5 8.5L13 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                          </span>
          ...
          {/* FAQ Section */}
          <motion.div variants={item} className="mt-32 pb-20">
