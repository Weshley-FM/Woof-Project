...
export default function RegisterPage() {
  return (
    <div className="min-h-screen w-full bg-[#0a0a0a] flex flex-col font-sans text-white">
      <div className="flex-1 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-12 lg:gap-16 mx-auto items-center">
        ...
        <div className="flex-1 flex flex-col justify-center w-full lg:items-end">
          ...
          <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
            <div className="flex flex-col sm:flex-row gap-5">
              <div className="flex flex-col gap-2 flex-1">
                ...
                <input 
                  type="text" 
                  placeholder="Name" 
                  className="bg-[#1a1a1a] border border-white/5 rounded-xl px-4 py-3.5 text-[15px] text-white placeholder-white/30 focus:outline-none focus:border-[#bfff00]/50 transition-colors"
                />
              </div>
              <div className="flex flex-col gap-2 flex-1">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-[#1a1a1a] border border-white/5 rounded-xl px-4 py-3.5 text-[15px] text-white placeholder-white/30 focus:outline-none focus:border-[#bfff00]/50 transition-colors"
                />
            ...
            <button type="submit" className="w-full bg-[#bfff00] text-black font-medium text-[16px] py-3.5 rounded-xl hover:bg-[#bfff00]/90 transition-colors mt-2">
              Sign up
            </button>
      ...
      <div className="hidden lg:flex flex-1 h-[700px] xl:h-[800px] w-full justify-start" data-reveal="right" style={{ '--reveal-delay': '200ms' }}>
        <div className="w-full max-w-[480px] h-full rounded-[2.5rem] bg-gradient-to-br from-[#8DC63F] to-[#4F791A] relative overflow-hidden flex flex-col items-center justify-center text-center px-12 shadow-2xl">
          ...
          <div className="relative z-10 max-w-lg">
            <h2 className="text-[40px] font-sans font-medium text-white mb-6">
              Get Started With Us
            </h2>
